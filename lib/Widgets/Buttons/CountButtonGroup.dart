...
class CountButtonGroup extends StatefulWidget implements PreferredSizeWidget {
  ...
  const CountButtonGroup(
      {Key key, this.step = 1, this.getText, this.setCount, this.getCount})
      : super(key: key);
...
class _CountButtonGroupState extends State<CountButtonGroup>
                ...
                Opacity(
                    ...
                    child: Container(
                        decoration: BoxDecoration(
                            border: Border(
                                top: BorderSide(
                                    width: 1, color: ColorConstants.gray),
                                bottom: BorderSide(
                                    width: 1, color: ColorConstants.gray))),
                        height: 36,
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (String value) => {
                            setState(() => {
                                  widget.setCount(int.tryParse(value)),
                                  _updateAnimation()
                                })
                          },
                        ))),
