...
class CustomButton extends StatelessWidget implements PreferredSizeWidget {
  ...
  CustomButton(
      ...
      this.expanded = false})
      : super(key: key);
  CustomButton.coloredNoBorderLeft(
      {Key key,
      Color color,
      this.width,
      this.height,
  ...
  CustomButton.coloredCustomRadius(
      {Key key,
      Color color,
      double radius,
      this.width,
  ...
  CustomButton.colored(
    ...
    decoration = BoxDecoration(
      borderRadius: BorderRadius.only(
        ...
        bottomRight:
            Radius.circular(ParametersConstants.smallImageBorderRadius),
      ),
      color: color,
    );
  }
  ...
  Widget build(BuildContext context) {
    BoxDecoration decorationA =
        enable ? decoration : decoration.copyWith(color: Colors.grey);
