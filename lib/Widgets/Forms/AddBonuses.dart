...
class _AddBonusesState extends State<AddBonuses>{
  ...
  Widget build(BuildContext context) {
    ...
    var bonusCount =Resources().userProfile.bonusPoints.clamp(0, Resources().cart.cartPrice/2); 
          ...
          Container(
            ...
            child: SliderTheme(
                ...
                data: SliderThemeData(
                    ...
                    thumbShape: CircleThumbShape(mainColor:ColorConstants.mainAppColor,thumbRadius: 15,innerColor:ColorConstants.red,borderColor:ColorConstants.gray,innerThumbRadius: 5  ),),
                    child: Slider(
