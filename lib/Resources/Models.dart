...
class PriceData implements IDataJsonModel{
  ...
  factory PriceData.fromJson(Map<String, dynamic> json) =>
      PriceData(
          ...
          quantity: json["PRODUCT_QUANTITY"]!= null? double.tryParse(json["PRODUCT_QUANTITY"]):0,
      );
...
class GoodsData implements IDataBaseModel,IDataJsonModel{
  ...
  PriceData getPrice(){
   // cart.forEach((k,v) =>print(Resources().getGodById(k)));
    return price.firstWhere((x)=>  Resources().getAllShops.firstWhere((y)=>y.shopId == Resources().userProfile.selectedShop).priceId  == x.storeId,orElse: () => PriceData() );
  ...
  factory GoodsData.fromJson(Map<String, dynamic> json){
    ...
    var price = json["PRICES"] != null ? List<PriceData>.from(
        ((json["PRICES"].values as Iterable).map((x) =>
            PriceData.fromJson(x)))) : List<PriceData>();
  var mesure =  json["MEASURE"] == "кг" ? "кг" : json["MEASURE"];
    ...
    return GoodsData(
      ...
      previewText: json["PREVIEW_TEXT"].toString().replaceHTMLSpecialChars(),
      detailText: json["DETAIL_TEXT"].toString().replaceHTMLSpecialChars(),
      price:price,
...
class Cart implements IDataJsonModel,IDataBaseModel
{
  ...
  factory Cart.fromJson(Map<String, dynamic> newJson){
    ...
    if(newJson["BASKET"] != null){
      (newJson["BASKET"] as List).forEach((x)=>{ map[int.parse(x["ID"])]=(x["QUANTITY"].toDouble()), mapPrice[int.parse(x["ID"])]=(x["PRICE"].toDouble())
...
class CategoryData{
  ...
  factory CategoryData.fromJson(Map<String, dynamic> json) =>
      CategoryData(
        ...
        title: json["NAME"],
        parentId: json["IBLOCK_SECTION_ID"] != null? int.parse( json["IBLOCK_SECTION_ID"]):0,
...
class ShopInfo {
  ...
  factory ShopInfo.fromJson(Map<String, dynamic> json) =>
      ShopInfo(
        ...
        mapPoint: Point(latitude:double.parse(json["MAP_POINTS"].toString().split(',')[0]),longitude:double.parse(json["MAP_POINTS"].toString().split(',')[1])),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "ADDRESS": address,
    "PHONES": phones,
    "MAP_POINTS": [mapPoint.latitude.toString(),mapPoint.longitude.toString()],
    "WORK_TIME": workTime,
    "DETAIL_TEXT": detailText,
    "PREVIEW_PICTURE": previewImage,
    "DETAIL_PICTURE": detailImage,
  };
  ShopInfo( {this.shopId = 0,this.city = 0,this.address= "",this.priceId=1,this.mapPoint= const Point(latitude:0.0,longitude:0.0),this.id =0, this.phones=const [''],this.workTime="", this.detailText="", this.previewImage="", this.detailImage="",});
}
...
class UserProfile {
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) =>
      UserProfile(
        ...
        email: json["email"],
        phone: json["phone"],
        userAddress: json["userProps"] !=null?List<UserAddress>.from((json["userProps"].values).map((x) =>UserAddress.fromJson(x))): List<UserAddress>(),
